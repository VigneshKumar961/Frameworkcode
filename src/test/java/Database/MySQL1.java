...
public class MySQL1 extends base{
		...
		ResultSet rs = s.executeQuery("select * from job_status where job_id='JOB_ARC_BRM_ACNT_202207220416385'");
		
		while(rs.next()) {
			System.out.println("The Status is " +rs.getString("stage")+" "+rs.getString("status"));
